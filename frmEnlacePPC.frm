...
Begin VB.Form frmEnlacePPC 
   ...
   Begin VB.Frame frmPPC 
      ...
      Begin VB.ComboBox cbPista 
         ...
         EndProperty
         Height          =   390
         ItemData        =   "frmEnlacePPC.frx":2044
         Left            =   765
         List            =   "frmEnlacePPC.frx":2066
         Style           =   2  'Dropdown List
         TabIndex        =   37
         Top             =   1710
         Width           =   1065
   ...
   End
End
Attribute VB_Name = "frmEnlacePPC"

    ...
    With gNoAgrupados
        ...
        For i = 0 To gNoAgrupados.Rows - 1
            ...
            If .Text = "   X" Then
                ...
                'en caso contrario
                ' Si la categoría es la misma que la anterior
                ...
                '   En este caso solo anexamos la categoría
                ' Si el grupo es distinto
                '  Generamos la cadena y comenzamos de nuevo con el nuevo grupo y categoría
                If sCategAnt = "" Then
                    sDenomCateg = sCateg
                    sDenomGrupo = sGrupo
                ElseIf sCategAnt = sCateg Then
                    ...
                    End If
                Else
                    If sGrupoAnt = sGrupo Then 'Categoría distinta pero mismo grupo
                        'Solo anexamos la categoría si en el grupo anterior solo hay un grupo
                        ...
                        Else
                            ...
                            GoTo inicializar
                        End If
                    Else 'Categoría distinta y distinto grupo
inicializar:
                        'Componemos parte del nombre y asociamos grupo y categoría de nuevo

...
Begin VB.Form frmEnlacePPC2 
   ...
   Begin VB.Frame frmPPC 
      ...
      Begin VB.CommandButton cmdPuntuaciones 
         Height          =   435
         Left            =   9540
         Picture         =   "frmEnlacePPC2.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   119
      ...
      Begin VB.CommandButton cmdSelFase 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC2.frx":1024
         Style           =   1  'Graphical
         TabIndex        =   49
         Top             =   1305
         Width           =   450
      ...
      Begin VB.CommandButton cmdSelCat 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC2.frx":148E
         Style           =   1  'Graphical
         TabIndex        =   48
         Top             =   855
         Width           =   450
      ...
      Begin VB.CommandButton cmdSelComp 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC2.frx":18F8
         Style           =   1  'Graphical
         TabIndex        =   47
         Top             =   360
         Width           =   450
      ...
      Begin VB.CommandButton cmdDatos 
         ...
         Height          =   435
         Left            =   9060
         Picture         =   "frmEnlacePPC2.frx":1D62
         Style           =   1  'Graphical
         TabIndex        =   41
      ...
      Begin VB.ComboBox cbPista 
         ...
         EndProperty
         Height          =   390
         ItemData        =   "frmEnlacePPC2.frx":2044
         Left            =   765
         List            =   "frmEnlacePPC2.frx":2066
         Style           =   2  'Dropdown List
         TabIndex        =   37
         Top             =   1710
         Width           =   1065
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdSubirDatosSigFase 
            ...
            Height          =   360
            Left            =   90
            Picture         =   "frmEnlacePPC2.frx":2099
            Style           =   1  'Graphical
            TabIndex        =   77
            Top             =   270
            Width           =   405
         ...
         Begin VB.CommandButton cmdDatosFaseSig 
            ...
            Height          =   405
            Left            =   5250
            Picture         =   "frmEnlacePPC2.frx":2503
            Style           =   1  'Graphical
            TabIndex        =   40
            ToolTipText     =   "mml_FRASE0425"
            Top             =   240
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdSubirDatos 
            ...
            Height          =   360
            Left            =   90
            Picture         =   "frmEnlacePPC2.frx":27E5
            Style           =   1  'Graphical
            TabIndex        =   50
            Top             =   225
            Width           =   405
         ...
         Begin VB.CommandButton cmdDatosFaseAct 
            ...
            Height          =   495
            Left            =   6210
            Picture         =   "frmEnlacePPC2.frx":2C4F
            Style           =   1  'Graphical
            TabIndex        =   39
            ToolTipText     =   "mml_FRASE0425"
            Top             =   150
      ...
      Begin VB.CommandButton cmdDescalif 
         Height          =   435
         Left            =   10020
         Picture         =   "frmEnlacePPC2.frx":2F31
         Style           =   1  'Graphical
         TabIndex        =   13
      ...
      Begin VB.CommandButton cmdDorsales 
         Height          =   375
         Left            =   9840
         Picture         =   "frmEnlacePPC2.frx":3B13
         Style           =   1  'Graphical
         TabIndex        =   12
      ...
      Begin VB.CommandButton cmdCategAct 
         Height          =   375
         Left            =   9060
         Picture         =   "frmEnlacePPC2.frx":4635
         Style           =   1  'Graphical
         TabIndex        =   11
   ...
   End
End
Attribute VB_Name = "frmEnlacePPC2"

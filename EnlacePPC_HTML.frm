        ...
        If iTodasPuntuaciones = C_TODAS_PUNTUACIONES Or _
           (iTodasPuntuaciones = C_PUNTUACIONES_CINCO_BAILES And Val(tbCodBaileAct.Text) = 0) Then
            ...
            If tbCodCatSig.Text <> "" Then
                'Si no se selecciona el modo de 10 bailes, independientemente del baile de partida configurado, siempre encontrará la fase
                'Si está activo el modo de 10 bailes, solo localiza cada fase si el baile seleccionado coincide con el del horario
                'Calculamos la siguiente categoria si antes de entrar existía
                sSQL = SQL_SIG_CATEG
                Debug.Print sSQL
            ...
            If G_GEN_AUTO_RESULTADOS_PPC Then
                ...
                If lblActTimer.BackColor <> vbRed Then
                    'Si estamos calculando de nuevo antes de que pasen 40 segundos desactivamos el sitema automático
...
continuar:
                        ...
                        If tbCodCatAct.Text = "" Then
                            'Entramos a calcular la última categoría

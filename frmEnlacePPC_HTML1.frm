VERSION 5.00
Begin VB.Form frmEnlacePPC_HTML1 
   ...
   ClientTop       =   345
   ClientWidth     =   10695
   Icon            =   "frmEnlacePPC_HTML1.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ...
   Begin VB.Frame frmPPC 
      ...
      Begin VB.CommandButton cmdCategAct 
         Height          =   375
         Left            =   9060
         Picture         =   "frmEnlacePPC_HTML1.frx":0442
         Style           =   1  'Graphical
         TabIndex        =   73
      ...
      Begin VB.CommandButton cmdDorsales 
         Height          =   375
         Left            =   9840
         Picture         =   "frmEnlacePPC_HTML1.frx":074C
         Style           =   1  'Graphical
         TabIndex        =   72
      ...
      Begin VB.CommandButton cmdDescalif 
         Height          =   435
         Left            =   10020
         Picture         =   "frmEnlacePPC_HTML1.frx":126E
         Style           =   1  'Graphical
         TabIndex        =   71
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton cmdSubirDatos 
            ...
            Height          =   360
            Left            =   90
            Picture         =   "frmEnlacePPC_HTML1.frx":1E50
            Style           =   1  'Graphical
            TabIndex        =   29
            Top             =   225
            Width           =   405
      ...
      Begin VB.Frame Frame3 
         ...
         Begin VB.CommandButton cmdSubirDatosSigFase 
            ...
            Height          =   360
            Left            =   90
            Picture         =   "frmEnlacePPC_HTML1.frx":22BA
            Style           =   1  'Graphical
            TabIndex        =   21
            Top             =   270
            Width           =   405
      ...
      Begin VB.ComboBox cbPista 
         ...
         EndProperty
         Height          =   390
         ItemData        =   "frmEnlacePPC_HTML1.frx":2724
         Left            =   765
         List            =   "frmEnlacePPC_HTML1.frx":2746
      ...
      Begin VB.CommandButton cmdDatos 
         ...
         Height          =   435
         Left            =   9060
         Picture         =   "frmEnlacePPC_HTML1.frx":2779
         Style           =   1  'Graphical
         TabIndex        =   16
      ...
      Begin VB.CommandButton cmdSelComp 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC_HTML1.frx":2A5B
         Style           =   1  'Graphical
         TabIndex        =   14
         Top             =   360
         Visible         =   0   'False
      ...
      Begin VB.CommandButton cmdSelCat 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC_HTML1.frx":2EC5
         Style           =   1  'Graphical
         TabIndex        =   13
         Top             =   855
         Width           =   450
      ...
      Begin VB.CommandButton cmdSelFase 
         ...
         Height          =   360
         Left            =   1845
         Picture         =   "frmEnlacePPC_HTML1.frx":332F
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   1305
         Width           =   450
      ...
      Begin VB.CommandButton cmdPuntuaciones 
         Height          =   435
         Left            =   9540
         Picture         =   "frmEnlacePPC_HTML1.frx":3799
         Style           =   1  'Graphical
         TabIndex        =   1
   ...
   End
End
Attribute VB_Name = "frmEnlacePPC_HTML1"
